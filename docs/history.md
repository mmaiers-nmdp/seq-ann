...
- Fixed issues with annotating class II sequences with large insertions
  (HLA-DRB1\*04:04:01)

## 0.0.29 (2018-06-14)

- Fixed issue caused by annotating partial sequences with no locus
  provided
...
- The alignments are now done using the previous partial alignment
  instead of redoing the sequence search step.
